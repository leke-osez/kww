...
//   };
//   return (
//     <div className="px-5 relative pt-7" ref={cartRef}>
//       <div className="">
//         <button
//           type="button"
...
//           <span className="text-lg font-semibold text-black/60">({totalQuantity} {totalQuantity > 1 ? 'items' : 'item'})</span>
//         </button>

//         {cartItems.length < 1 && (
//           <div className="flex  flex-col items-center justify-start space-y-6" >
//             <AiOutlineShopping size={150} className = 'text-green-500'/>
//             <h3 className="text-3xl font-bold">Your shopping bag is empty</h3>
//             <Link href= '/products'>
//               <p
...
//           </div>
//         )}
//         <div className="w-full space-y-10 overflow-scroll h-[500px] scroll">
//           {cartItems.length >= 1 &&
//             cartItems.map((item) => (
...
//                   />
//                 </div>
//                 <div className="w-[50%] flex justify-between items-start relative pl-3">
//                   <div className="space-y-1">
//                     <h5 className="text-xl font-semibold capitalize">{item.name}</h5>
...
//               <h3 className="text-xl font-semibold">{money(cartItems.reduce((total,item)=> total + (item.quantity * (item.price)), 0))}</h3>
//             </div>
//             <div 
//                 className=" w-[full] flex justify-center items-center"
//             >
//               <button type="button" className="text-xl text-white bg-purple-900 w-[70%] font-semibold text-center px-3 py-3 flex justify-center items-center" onClick={handleCheckout}>
//                 Pay with Stripe
//               </button>
//             </div>
//           </div>
