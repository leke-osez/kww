...
const Category = ({products, filter}) => {
  return (
    <div className='md:mt-10  bg-inherit relative w-fit'>
        {/* header */}
        ...
        {/* Products */}
        <div className='mr-3 md:mr-5 xl:mr-7 gap-4 md:gap-5 xl:gap-10 grid sm:grid-cols-3 xl:grid-cols-4 grid-cols-2'>
